...
BEGIN
    RAISE NOTICE '============================';
    start_batch := CURRENT_TIMESTAMP;
    RAISE NOTICE ' Silver load starts ';
    RAISE NOTICE '----------------------------';
    ...
    RAISE NOTICE 'crm_cust_info load duration: % seconds',
    ...
    end_time := CURRENT_TIMESTAMP;
    RAISE NOTICE 'crm_prd_info load duration: % seconds',
        ROUND(EXTRACT(EPOCH FROM (end_time - start_time)), 2);
    ...
    end_time := CURRENT_TIMESTAMP;
    RAISE NOTICE 'crm_sales_details load duration: % seconds',
        ROUND(EXTRACT(EPOCH FROM (end_time - start_time)), 2);
    ...
    end_time := CURRENT_TIMESTAMP;
    RAISE NOTICE 'erp_cust_az12 load duration: % seconds',
        ROUND(EXTRACT(EPOCH FROM (end_time - start_time)), 2);
    ...
    end_time := CURRENT_TIMESTAMP;
    RAISE NOTICE 'erp_loc_a101 load duration: % seconds',
        ROUND(EXTRACT(EPOCH FROM (end_time - start_time)), 2);
    ...
    end_time := CURRENT_TIMESTAMP;
    RAISE NOTICE 'erp_px_cat_g1v2 load duration: % seconds',
        ROUND(EXTRACT(EPOCH FROM (end_time - start_time)), 2);
    ...
    RAISE NOTICE ' Total load duration: % seconds',
        ROUND(EXTRACT(EPOCH FROM (end_batch - start_batch)), 2);
    RAISE NOTICE '==========================================';
